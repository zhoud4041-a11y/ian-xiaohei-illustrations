...
description: 使用“小代”固定卡通 IP 生成中文正文配图。用于用户要求为中文文章、帖子、博客、Notion 文档、工作流文档、方法论、流程、结构、状态、隐喻或观点生成手绘正文配图、文章插图、配图建议、shot list、去标题或改图；小代是黑色短碎发、黑框眼镜、浅蓝 T 恤和蓝色花纹短裤的年轻男性角色，搭配纯白手绘、少量红橙蓝批注和简洁清爽的视觉风格。
---
...
默认视觉 IP 是“小代”：黑色短碎发、黑色粗框矩形眼镜、浅蓝 T 恤、蓝色花纹短裤、人字拖和黑色腕表。小代必须参与画面的核心动作，不能只是站在旁边当装饰。
...
- `references/xiaodai-ip.md`：小代的固定外形、性格、动作和禁忌。
...
- `assets/character-reference/xiaodai-reference-v1.png`：小代身份与外形的唯一视觉参考。每次生成前必须查看。
