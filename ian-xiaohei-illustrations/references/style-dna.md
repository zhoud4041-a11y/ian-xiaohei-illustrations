...
纯白、极简、手绘、留白、克制、轻松、有生活感、产品草图感、中文手写感、结构清楚但不说明书。
...
- 黑色手绘线稿为主：细线、轻微抖动、不机械、不矢量、不厚重描边。人物使用柔和的水彩或彩铅式平涂。
...
- 黑色：主体线稿、头发、眼镜、框线、结构、主要文字、主体物件。
- 浅蓝和蓝色：角色固定服装，也是人物识别色；不可随意改成其他主色。
...
要有创意、有意思、简洁清爽、带一点轻松荒诞和真实生活感。

可以亲切可爱，但不要幼稚、卖萌、很复杂或死板。
