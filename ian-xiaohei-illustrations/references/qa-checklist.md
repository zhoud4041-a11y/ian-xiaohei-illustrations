...
- 角色变成了通用吉祥物、儿童、真人、动物或黑色怪物。
- 眼镜缺失，发型、服装、配色或年龄感明显漂移。
- 画面像 PPT、课程课件、正式流程图。
- 元素太多、箭头太多、节点太多。
- 文字变成大段解释。
- 背景有纸纹、阴影、渐变、米色、噪点。
...
- 太普通：让个人角色成为动作主体，加入一个奇怪但成立的隐喻。
- 太复杂：删节点，只保留一个动作和 3-5 个短标注。
- 太幼稚：强调 young adult、thoughtful、natural expression、not a child、not a generic mascot。
